...
import { faPhone, faBars } from "@fortawesome/free-solid-svg-icons"; // '@fortawesome/free-solid-svg-icons'//fas is the prefix to select all icons from this library but we just want the phone icon here
...
library.add(faPhone, faFacebook, faInstagram, faBars);
createApp(App)
  .use(store)
  .use(router)
